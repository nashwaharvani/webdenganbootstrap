...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css"
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand" href="#">Pendaftaran Event</a>
        ...
        <div class="navbar-nav ml-auto">
            <a class="nav-item nav-link active" href="home_admin.php">Home <span class="sr-only">
                (current)</span></a>
  ...
  <div class="jumbotron jumbotron-fluid">
        <div class="container">
          ...
          <p class="lead text-white"><h4>ika anda ingin mngecek data yang sudah terdaftar maka klik navbar data 
